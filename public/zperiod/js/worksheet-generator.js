...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by Leo'sPhysics': {
        'zh-Hant': '由 Leo\'sPhysics 生成',
        fr: 'Genere par Leo\'sPhysics',
        ru: 'Сгенерировано в Leo\'sPhysics',
        fa: 'تولید شده توسط Leo\'sPhysics',
        ur: 'Leo\'sPhysics کی جانب سے تیار کردہ',
        tl: 'Nabuo ng Leo\'sPhysics'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by Leo\'sPhysics', '由 Leo\'sPhysics 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('Leo'sPhysics — Balancing Chemical Equations Worksheet', 'Leo'sPhysics — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by LeoPhysics</div>
