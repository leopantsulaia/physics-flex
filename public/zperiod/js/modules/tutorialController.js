...
function ensureDriverTutorialAssets() {
    ...
    if (!document.getElementById('driver-custom-leophysics')) {
        const style = document.createElement('style');
        style.id = 'driver-custom-leophysics';
        style.textContent = `
    ...
    try {
        ...
        if (!document.getElementById('driver-css')) {
            ...
            style.textContent = `
                ...
                /* Style the popover to look more elegant and modern, matching LeoPhysics UI */
                .custom-driver-popover {
                    border-radius: 20px !important;
                    box-shadow: 0 4px 20px rgba(0,0,0,0.1) !important;
                    border: none !important;
