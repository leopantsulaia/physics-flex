...
export const changelogLocales = {
  ...
  fr: {
    ...
    "1.0.0": {
      date: "2026-02-07",
      changes: [
        "Sortie officielle v1.0 — Leo'sPhysics devient public",
        ...
        "Domaine personnalisé (leosphysics.app) configuré",
      ],
    },
    "0.5.0": {
      date: "2026-01-14",
  ...
  fa: {
    ...
    "1.0.0": {
      date: "2026-02-07",
      changes: [
        "نسخه رسمی نسخه 1.0 - Leo'sPhysics عمومی می شود",
        ...
        "دامنه سفارشی (leosphysics.app) پیکربندی شد",
      ],
    },
    "0.5.0": {
      date: "2026-01-14",
  ...
  ur: {
    ...
    "1.0.0": {
      date: "2026-02-07",
      changes: [
        "سرکاری v1.0 ریلیز — Leo'sPhysics عوامی ہے۔",
        ...
        "حسب ضرورت ڈومین (leosphysics.app) کنفیگر ہو گیا۔",
      ],
    },
    "0.5.0": {
      date: "2026-01-14",
  ...
  tl: {
    ...
    "1.0.0": {
      date: "2026-02-07",
      changes: [
        "Opisyal na paglabas ng v1.0 — Pumupunta sa publiko ang Leo'sPhysics",
        ...
        "Na-configure ang custom na domain (leosphysics.app).",
      ],
    },
    "0.5.0": {
      date: "2026-01-14",
